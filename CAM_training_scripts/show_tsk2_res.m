...
load('/gpfs/share/home/1800011374/SRM30_tsk2_low_res1/EpisodeData','env')
env_ref = env;
...
figure(1)
plot(-180*ones(1,EpisodeNum),'-k','LineWidth',1)
hold on
...
figure(4)
plot(env_ref.StepReward,'-k','LineWidth',1)
hold on
plot(env.StepReward(EpisodeNum,:),'-b','LineWidth',1)
legend('constant','RL')
xlabel('StepNumber (month)')
ylabel('StepReward')
set(gca,'FontSize',15)