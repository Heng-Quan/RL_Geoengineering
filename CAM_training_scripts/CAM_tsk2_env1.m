classdef CAM_tsk2_env1 < rl.env.MATLABEnvironment    
    ...
    properties
        ...
        BNDTVAER_file = ['/gpfs/share/home/1800011374/',...
            'CAM3_SOM_low_res/AerosolMass_V_32x64_varying7.nc'];
        init_file = '';
        init_file_clm = '';
        init_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res7/SRM_RL_run.cam2.i.00'];
        init_head_clm = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res7/SRM_RL_run.clm2.i.00']
        output_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res7/SRM_RL_run.cam2.h0.00'];
    ...
    methods              
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = ...
            ...
            'bndtvaer=''/gpfs/share/home/1800011374/CAM3_SOM_low_res/AerosolMass_V_32x64_varying7.nc'', ',...
            ...
            '-o /gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL7'];
            
            system(namelist_command);
            
            % run CAM for 1 month
            while exist('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL7','file') == 0
                pause(1)
            ...
            '/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL7'];
            ...
            delete('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL7');
            output_file_new = [this.output_head, num2str(year,'%02d'),...
                '-', num2str(month,'%02d'), '_copy', '.nc'];
            movefile(output_file,output_file_new);
            !> '/gpfs/share/home/1800011374/SRM_RL_CAM_low_res7/SRM_RL_run.out'
    ...
    methods               
        ...
        function Reward = getReward(this)
            ...
            Reward_TS = -dot(cos(this.lat*pi/180),TS_diff)/...
    ...
    methods (Access = protected)
        ...
        function envUpdatedCallback(this)
            ...
            saveas(gcf,'/gpfs/share/home/1800011374/SRM_RL_CAM_low_res7/temp.jpg')
        end
    end
end
