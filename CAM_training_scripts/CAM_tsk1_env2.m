classdef CAM_tsk1_env2 < rl.env.MATLABEnvironment    
    ...
    properties
        ...
        BNDTVAER_file = ['/gpfs/share/home/1800011374/',...
            'CAM3_SOM_low_res/AerosolMass_V_32x64_varying4.nc'];
        init_file = '';
        init_file_clm = '';
        init_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res4/SRM_RL_run.cam2.i.00'];
        init_head_clm = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res4/SRM_RL_run.clm2.i.00']
        output_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res4/SRM_RL_run.cam2.h0.00'];
    ...
    methods              
        ...
        function this = CAM_tsk1_env2()
            ...
            % lat_idx: [1,4,7,10,13,16,17,20,23,26,29,32], 16 same as 17
            ActionInfo = rlNumericSpec([11 1]);
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = ...
            ...
            MSUL_V_top(1:16) = interp1(1:3:16,Action(1:6),1:16,'linear');
            MSUL_V_top(17:32) = interp1(1:3:16,Action(6:11),1:16,'linear');
            ...
            'bndtvaer=''/gpfs/share/home/1800011374/CAM3_SOM_low_res/AerosolMass_V_32x64_varying4.nc'', ',...
            ...
            '-o /gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL4'];
            
            system(namelist_command);
            
            % run CAM for 1 month
            while exist('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL4','file') == 0
                pause(1)
            ...
            '/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL4'];
            ...
            delete('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL4');
            output_file_new = [this.output_head, num2str(year,'%02d'),...
                '-', num2str(month,'%02d'), '_copy', '.nc'];
            movefile(output_file,output_file_new);
            !> '/gpfs/share/home/1800011374/SRM_RL_CAM_low_res4/SRM_RL_run.out'
    ...
    methods (Access = protected)
        ...
        function envUpdatedCallback(this)
            ...
            saveas(gcf,'/gpfs/share/home/1800011374/SRM_RL_CAM_low_res4/temp.jpg')
        end
    end
end
