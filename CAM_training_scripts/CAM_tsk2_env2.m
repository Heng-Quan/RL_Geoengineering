classdef CAM_tsk2_env2 < rl.env.MATLABEnvironment    
    ...
    properties
        ...
        BNDTVAER_file = ['/gpfs/share/home/1800011374/',...
            'CAM3_SOM_low_res/AerosolMass_V_32x64_varying1.nc'];
        init_file = '';
        init_file_clm = '';
        init_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res1/SRM_RL_run.cam2.i.00'];
        init_head_clm = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res1/SRM_RL_run.clm2.i.00']
        output_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM_low_res1/SRM_RL_run.cam2.h0.00'];
    ...
    methods              
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = ...
            ...
            'bndtvaer=''/gpfs/share/home/1800011374/CAM3_SOM_low_res/AerosolMass_V_32x64_varying1.nc'', ',...
            ...
            '-o /gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL1'];
            
            system(namelist_command);
            
            % run CAM for 1 month
            while exist('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL1','file') == 0
                pause(1)
            ...
            '/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL1'];
            ...
            delete('/gpfs/share/home/1800011374/CAM3_SOM_low_res/namelist_tsk1_RL1');
            output_file_new = [this.output_head, num2str(year,'%02d'),...
                '-', num2str(month,'%02d'), '_copy', '.nc'];
            movefile(output_file,output_file_new);
            !> '/gpfs/share/home/1800011374/SRM_RL_CAM_low_res1/SRM_RL_run.out'
        ...
        function InitialObservation = reset(this)
            ...
            load('tsk2_ref.mat','TS_initial','PminusE_initial');
            this.TS_buffer = TS_initial;
            this.TS_smooth = mean(TS_initial,3);
            this.PminusE_buffer = PminusE_initial;
            this.PminusE_smooth = mean(PminusE_initial,3);
    ...
    methods               
        ...
        function Initialize_properties(this)
            ...
            load('tsk2_ref.mat','TS_control','TS_2xCO2','TS_initial',...
                'PminusE_control','PminusE_2xCO2','PminusE_initial');
            this.TS_original = mean(TS_control,3);
            this.TS_initial = mean(TS_initial,3);
            this.TS_2CO2 = mean(TS_2xCO2,3);

            this.PminusE_original = mean(PminusE_control,3);
            this.PminusE_initial = mean(PminusE_initial,3);
            this.PminusE_2CO2 = mean(PminusE_2xCO2,3);
            
            load('tsk2_ref_rwd.mat','TS_ref_rwd','PminusE_ref_rwd')
        ...
        function Reward = getReward(this)
            ...
            Reward = -dot(cos(this.lat(11:22)*pi/180),TS_diff(11:22))/...
    ...
    methods (Access = protected)
        ...
        function envUpdatedCallback(this)
            ...
            hold on
            plot(this.lat,mean(this.TS_smooth - this.TS_original,1),'-b','LineWidth',1)
            hold on
            plot(this.lat,zeros(1,32),'--k','LineWidth',1)
            ylabel('K')
            xlabel('latitude')
            title('ΔTS profile')
            ...
            saveas(gcf,'/gpfs/share/home/1800011374/SRM_RL_CAM_low_res1/temp.jpg')
        end
    end
end
