classdef CAM_env_smooth < rl.env.MATLABEnvironment    
    ...
    properties
        ...
        BNDTVAER_file = ['/gpfs/share/home/1800011374/',...
            'CAM3_SOM/AerosolMass_V_64x128_varying6.nc'];
        init_file = '';
        init_file_clm = '';
        init_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM6/SRM_RL_run.cam2.i.00'];
        init_head_clm = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM6/SRM_RL_run.clm2.i.00']
        output_head = ['/gpfs/share/home/1800011374/',...
            'SRM_RL_CAM6/SRM_RL_run.cam2.h0.00'];
    ...
    methods              
        ...
        function [Observation,Reward,IsDone,LoggedSignals] = ...
            ...
            'bndtvaer=''/gpfs/share/home/1800011374/CAM3_SOM/AerosolMass_V_64x128_varying6.nc'', ',...
            'bndtvs=''/gpfs/share/home/1800011374/CAM3_SOM/sst_HadOIBl_bc_64x128_clim_SOM_c021214.nc'', ',...
            'inithist=''MONTHLY''/ ',...
            ['&clmexp finidat=''' this.init_file_clm '''/" '],...
            '-o /gpfs/share/home/1800011374/CAM3_SOM/namelist_SRM_RL6'];
            
            system(namelist_command);
            
            % run CAM for 1 month
            while exist('/gpfs/share/home/1800011374/CAM3_SOM/namelist_SRM_RL6','file') == 0
                pause(1)
            ...
            '/gpfs/share/home/1800011374/CAM3_SOM/namelist_SRM_RL6'];
            ...
            delete('/gpfs/share/home/1800011374/CAM3_SOM/namelist_SRM_RL6');
            output_file_new = [this.output_head, num2str(year,'%02d'),...
                '-', num2str(month,'%02d'), '_copy', '.nc'];
            movefile(output_file,output_file_new);
            !> '/gpfs/share/home/1800011374/SRM_RL_CAM6/SRM_RL_run.out'
    ...
    methods (Access = protected)
        ...
        function envUpdatedCallback(this)
            ...
            saveas(gcf,'/gpfs/share/home/1800011374/SRM_RL_CAM6/temp.jpg')
        end
    end
end
